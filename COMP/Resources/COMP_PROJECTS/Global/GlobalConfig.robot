...
${cfg_global_login_profile}    autoqadef    # here we pass one variable 'default' in this case to control lots of variables with _default at the end.
...
${cfg_global_login_username_qa012}    jhennessy
