...
::cd C:\Users\gfung\.jenkins\workspace\SMP-API-Talent_Pool_QA052\TestSuites\
:: cd C:\Users\gfung\.jenkins\workspace\SMP-API-Talent_Pool\COMPQA052\TestSuites\
::cd C:\Users\gfung\.jenkins\workspace\SMP-API-Talent_Pool\COMPQA052\TestSuites\
cd C:\Users\gfung\.jenkins\workspace\SMP-API-Talent_Pool_QA052\COMP\TestSuites\
...
cmd /c pybot --outputdir OG_TEST_RESULTS  -i POST -i PUT -i GET -i DELETE -v RNOAUTH_HOST:QA052_RL -v api_global_parameter_profile:qa052  --listener TestRailListener:479 SMP-API-Talent_Pool.robot
